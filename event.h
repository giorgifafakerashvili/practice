...
#define EVENT_SIGNAL(ev) ((int)(v)->ev_fd) 
#define EVENT_FD(ev) 	 ((int)(v)->ev_fd) 
...
#define event_initialized(ev)			event_initialized(ev)
...
const char* event_get_vesion(void); 
...
void event_active(struct event* ev, int res, short ncalls); /* ncall is being ignored */ 

int event_pending (struct event* ev, short, struct timeval* tv); 

int event_priority_int (int npri); 
...
int event_base_loopexit (struct event_base* base, int); 
int event_base_dispatch (struct event_base* base, struct timeval* tv); 
int event_base_once (struct event_base* base, int fd, short events, void (*cb)(int, short, void*), void* arg, 
					 struct timeval* tv); 
int event_base_priority_init(struct event_base* base, int fd); 

/* 
 * Next line is different in libevent+libev version
 * /libevent-include 
 */ 
